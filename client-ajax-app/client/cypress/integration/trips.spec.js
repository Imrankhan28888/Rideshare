// client/cypress/integration/trips.spec.js
...
const driverEmail = 'driver@rideShare.com'
const driverFirstName = 'Driver1'
const driverLastName = 'Test1'

// const riderEmail = faker.internet.email();
// const riderFirstName = faker.name.firstName();
// const riderLastName = faker.name.lastName();

const riderEmail = 'rider@rideShare.com'
const riderFirstName = 'Mithun'
const riderLastName = 'Banerjee'
